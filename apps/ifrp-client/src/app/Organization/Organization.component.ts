...
export class OrganizationComponent implements OnInit {
  ...
  addParticipant(form: any): Promise<any> {
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceOrganization.updateParticipant(form.get('identifier').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.duns) {
        formObject.duns = result.duns;
      } else {
        formObject.duns = null;
      }

      if (result.place) {
        formObject.place = result.place;
      } else {
        formObject.place = null;
      }
